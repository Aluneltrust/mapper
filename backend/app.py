...
def get_state_distances(route_points, total_google_distance=None):
    ...
    try:
        ...
        print("Post-adjustment distances:", state_distances)
...
def calculate_distance_in_miles(geometry):
    ...
    try:
        ...
        if isinstance(geometry, MultiLineString):
            for line in geometry.geoms:  # Use .geoms to get the individual LineStrings
                coords = list(line.coords)
                total_distance += calculate_distance_for_line(coords)
...
def calculate_distance_for_line(coords):
    """Helper function to calculate distance for a LineString"""
    total_distance = 0
